...
if __name__ == '__main__':
    ...
    path_base = "./datasets/422"

    jpgs_path   = path_base+"/JPEGImages"
    pngs_path   = path_base+"/SegmentationClass"
    ...
    classes     = ["_background_","arrester-z3Zj"]
    
    count = os.listdir(path_base+"/polygon/") 
    for i in range(0, len(count)):
        path = os.path.join(path_base+"/polygon", count[i])
